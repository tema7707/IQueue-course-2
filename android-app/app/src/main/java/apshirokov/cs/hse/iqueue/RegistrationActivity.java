...
public class RegistrationActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mRegistrationButton = findViewById(R.id.login_button);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, name, sex, city, age);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private final Boolean mSex;
        private final String mCity;
        private final Integer mAge;

        UserLoginTask(String email, String password, String name, Boolean sex, String city, Integer age) {
            mEmail = email;
            mPassword = password;
            mName = name;
            mSex = sex;
